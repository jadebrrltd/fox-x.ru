            ...
            <div class="controls-panel-crash">
                <form method="POST" id="bet_form">
                    ...
                    <div class="block-bet">
                        ...
                        {!! $bl !!}
                        <input type="number" name="bet" id="bet" placeholder="Ваша ставка" step="any" min="0">
                    </div>
                    ...
                    <div class="block-bet top">
                        ...
                        <input type="number" name="cashout" id="cashout" placeholder="Автовывод" step="0.01" min="0" onkeypress="doubleValidate(this)">
                ...
                <ul>
                    @foreach($games as $gf)
                        ...
                        <li class="color-{{$color}}">
                            <a href="javascript:void(0);" data-info="{{$g->profit}}" data-izimodal-open="#historyCrash" data-izimodal-transitionin="fadeInDown">
                                {{$g->profit}}
                        ...
                        @foreach($ubets as $bet)
                            <div class="result-table crash-table-body user-{{$bet['user']->id}}" data-cashout="{{$bet['bet']->number}}" data-bet="{{$bet['bet']->price}}" data-user="{{$bet['user']->id}}">
                                <div class="crash-body-title img">
                                    <img src="{{$bet['user']->image}}" alt="avatar">
