         ...
         $(document).ready(function() {
            window.Echo.join('online-users')
                ...
                .listen('EndGame', function(e) {
                    ...
                    if(currentGameId && currentGameId == e.gameId) {
                        setTimeout(function() {
                            MainFunction.lotto(e.winnerId, 5, 1, 1, -115, 10, 'showWinnerJackpot', e, 'choose-winner__slider');
                        }, 100);
                        setTimeout(function() {
...
//
                ...
                .listen('EndGameCoinflip', function(e) {
                    ...
                    if(account == e.accountId) {
                        setTimeout(function(){$('.balance__value').html(e.balance.toLocaleString() + '<span>COINS</span>');
                        },3000);
                    }
